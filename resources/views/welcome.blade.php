<x-guest-layout>
    <div class="container max-w-lg px-4 py-36 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center bg-gradient-to-r from-blue-200 to-purple-300">
        <h1
            class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-600 md:text-center sm:leading-none lg:text-5xl">
            <span class="inline md:block">Welcome To ImanFood Restaurant</span>
        </h1>
        <div class="mx-auto mt-2 text-blue-900 md:text-center lg:text-lg">
